...
function Chat({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={[cstyles.container, cstyles.bg_white]}>
      ...
      <View
        style={[
          { backgroundColor: Colors.lightGray, height: 50 },
          cstyles.row,
          cstyles.px_10,
          cstyles.py_10,
        ]}
      >
        <TouchableOpacity
          style={[
            styles.headerButn,
            view === "chat" && { borderBottomColor: Colors.secondryGradient },
          ]}
          onPress={() => setView("chat")}
        >
          <Text
            style={[
              styles.headerButnText,
              view === "chat" && { color: Colors.secondryGradient },
            ]}
          >
            Chat
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.headerButn,
            view === "highlights" && {
              borderBottomColor: Colors.secondryGradient,
            },
          ]}
        ...
        >
          <Text
            style={[
              styles.headerButnText,
              view === "highlights" && { color: Colors.secondryGradient },
            ]}
          >
            Highlights
          </Text>
      ...
      {view === "chat" ? (
        ...
        <HighLights chat_id={chat_id} navigation={navigation} />
      )}
    </SafeAreaView>
  );
}
