	...
	return (
		<Fragment>
			<View style={cstyles.container}>
				...
				<TextInput style={[ styles.boxShadow, styles.inputText, cstyles.my_15 ]} placeholder="Title" />
				<View>
					...
					<FlatList
						...
						renderItem={({ item }) => (
							<View style={[ styles.boxShadow, styles.categoryBox, cstyles.my_15, cstyles.mr_10 ]} />
						)}
